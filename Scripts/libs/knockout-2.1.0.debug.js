        ...
        insertPropertyAccessorsIntoJson: function (objectLiteralStringOrKeyValueArray) {
            ...
            for (var i = 0; keyValueEntry = keyValueArray[i]; i++) {
                ...
                if (keyValueEntry['key']) {
                    var QuoteedKey = ensureQuoteed(keyValueEntry['key']), val = keyValueEntry['value'];
                    resultStrings.push(QuoteedKey);
                    resultStrings.push(":");
                    ...
                    if (isWriteableValue(ko.utils.stringTrim(val))) {
                        ...
                        propertyAccessorResultStrings.push(QuoteedKey + " : function(__ko_value) { " + val + " = __ko_value; }");
                    }
